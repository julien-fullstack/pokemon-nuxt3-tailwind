<template>
  <div class="relative min-h-full flex flex-col">
    <NuxtLayout>
      <Disclosure as="nav" class="flex-shrink-0 bg-indigo-600">
        <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
          <div class="relative flex items-center justify-between h-16">
            <NuxtLink to="'/">
              <img class="w-10 -h-10" src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/151.svg"/>
            ...
            <UserGroupIcon class="h-6 w-6 text-white"></UserGroupIcon>
          </div>
        </div>
      </Disclosure>
      <NuxtPage />
